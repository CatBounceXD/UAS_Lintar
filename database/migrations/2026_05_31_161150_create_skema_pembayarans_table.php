...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('skema_pembayarans', function (Blueprint $table) {
            ...
            $table->string('skema_dipilih')->nullable();
            $table->string('va_full');
            $table->bigInteger('nominal_full');
            $table->string('va_termin1');
            $table->bigInteger('nominal_termin1');
            $table->string('va_termin2');
            $table->bigInteger('nominal_termin2');
            $table->bigInteger('total_termin');
            $table->timestamps();
        });
    }
